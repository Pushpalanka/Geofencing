...
//        mContainerView.addView(newView, 0);
    ...
    private void addMenuItemList() {
        ...
        // Set the text in the new row to a random country.
        for (int i =0; i<TODO_ITEMS.length;i++){
            final ViewGroup newView = (ViewGroup) LayoutInflater.from(this).inflate(
...
//                    Intent intent = new Intent(EditItemActivity.class);
...
//        });
    ...
    private static final String[] TODO_ITEMS = new String[]{
            "Todo Item 1", "Todo Item 2", "Todo Item 3", "Todo Item 4", "Todo Item 5",
            "Todo Item 6",
    };
